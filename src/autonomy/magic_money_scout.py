...
MAGIC_MONEY_LANES: list[MagicMoneyLane] = [
    ...
    MagicMoneyLane(
        name="Mail-In Rebate Sweep",
        category="rebates",
        url="https://www.rebatesme.com/",
        summary="Manufacturer/retailer mail-in and instant rebate forms - fill in profile/shipping, no purchase required to submit a rebate on something already owned.",
        tags=["mail in rebate", "rebate", "cash back", "no purchase"],
        autonomy_path="Scout open rebate forms -> prepare profile/shipping fields -> queue bulk-safe owner approval -> track payout.",
        ai_can_do=["find official rebate forms", "prepare profile fields", "prepare shipping/payout fields", "track rebate status"],
        stops_on=[],
    ),
    MagicMoneyLane(
        name="Instant Free Item Mailed Signup Lane",
        category="physical_goods",
        url="https://www.freestufftimes.com/",
        summary="\"Enter your email and address, hit accept\" style freebies - coins, stickers, welcome kits, samples mailed for a simple signup, no purchase.",
        tags=["free gift", "free coin", "welcome kit", "mailed", "no purchase", "instant signup"],
        autonomy_path="Scout instant-mail freebie campaigns -> prepare profile/shipping fields -> queue bulk-safe owner approval -> track shipment.",
        ai_can_do=["find official freebie forms", "prepare profile/shipping fields", "track shipment"],
        stops_on=[],
    ),
    MagicMoneyLane(
        name="Bank / Credit Union Signup Bonus Lane",
        category="bank_bonus",
        url="https://www.doctorofcredit.com/best-bank-account-bonuses/",
        summary="New account opening bonuses at banks/credit unions - AI can rank and prep profile fields, owner handles the actual account application and any identity/KYC step.",
        tags=["bank bonus", "credit union", "checking account", "signup bonus"],
        autonomy_path="Scout open bank/credit union bonus offers -> rank by payout/effort -> prepare profile fields -> owner completes account opening (identity-gated).",
        ai_can_do=["find official bonus offers", "rank by payout and requirements", "prepare profile fields", "track bonus posting"],
        stops_on=["identity verification", "account connection", "final submit"],
    ),
    MagicMoneyLane(
        name="Brokerage / Trading App Signup Bonus Lane",
        category="brokerage_bonus",
        url="https://www.nerdwallet.com/best/investing/free-stock-sign-up-bonuses",
        summary="Free-share/cash signup bonuses at brokerage and trading apps - AI can rank and prep profile fields, owner handles the actual brokerage account application (identity-gated).",
        tags=["free stock", "free share", "brokerage bonus", "signup bonus"],
        autonomy_path="Scout open brokerage signup bonuses -> rank by payout/effort -> prepare profile fields -> owner completes account opening (identity-gated).",
        ai_can_do=["find official bonus offers", "rank by payout and requirements", "prepare profile fields", "track bonus posting"],
        stops_on=["identity verification", "account connection", "final submit"],
    ),
    MagicMoneyLane(
        name="Cashback App Signup Bonus Lane",
        category="cashback_bonus",
        url="https://www.rakuten.com/referral",
        summary="Signup/referral bonuses on cashback and shopping-rewards apps - simple email signup, no purchase required to earn the welcome bonus itself.",
        tags=["cash back app", "signup bonus", "no purchase", "referral bonus"],
        autonomy_path="Scout open cashback app signup bonuses -> prepare profile fields -> queue bulk-safe owner approval -> track payout.",
        ai_can_do=["find official signup bonus offers", "prepare profile fields", "track payout status"],
        stops_on=[],
    ),
]
